const store = new Map();
// Each entry is a movimiento: { id, cliente_id, tipo, monto, fecha, referencia, descripcion, saldo_resultante }

const cuentasCorrientesStorage = {
...
module.exports = cuentasCorrientesStorage;
